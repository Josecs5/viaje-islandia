...
(function () {
  ...
  const LUGAR_SEED = [
    ...
    { id: 'seed-l8', nombre: 'Fjaðrárgljúfur', loc: { texto: 'Fjaðrárgljúfur parking', lat: 63.7702851, lng: -18.1716719 },
      fecha: '2026-10-10', visita: '60', prioridad: 'Media', orden: 670,
    ...
    { id: 'seed-l9', nombre: 'Diamond Beach', loc: { texto: 'Diamond Beach Parking North', lat: 64.0427984, lng: -16.1828417 },
      fecha: '2026-10-10', visita: '90', prioridad: 'Alta', orden: 675,
  ...
  const COMIDA_SEED = [
    ...
    { id: 'seed-c6', nombre: 'Cena en Vík', tipo: 'Cena',
      loc: { texto: 'Black Crust Pizzeria, Vík í Mýrdal', lat: 63.4189, lng: -19.0059 },
      fecha: '2026-10-09', horario: '20:00', orden: 1440,
      notas: 'Black Crust Pizzeria: pizza de masa con carbón activado, la especialidad de la casa — 1.290-3.990 ISK (~9-27 €) según tamaño, abierta 12:00-21:00. Está en el mismo pueblo que Vík Cottages (el alojamiento de esta noche), a un par de minutos en coche, así que no supone ningún desvío. Alternativa con más ambiente: Strondin Pub Vík, cocina de pub con vistas al Atlántico, algo más cara.' },
    { id: 'seed-c7', nombre: 'Comida rápida en Vík', tipo: 'Casual / rápido',
      loc: { texto: 'N1 Vík, Austurvegur, Vík í Mýrdal', lat: 63.4183, lng: -19.0074 },
      fecha: '2026-10-10', horario: '13:00', orden: 665,
      notas: 'Día apretado (Kvernufoss, el pecio del DC-3 y Reynisfjara antes de esto, y todavía quedan Fjaðrárgljúfur y Diamond Beach): mejor un bocadillo o un perrito caliente rápido en el N1 de Vík que sentarse a comer con calma. Perrito ~650-750 ISK. Si al final sobra tiempo, alternativa sentados en el mismo pueblo: Strondin Pub Vík o repetir en Black Crust Pizzeria (donde cenasteis anoche).' },
    { id: 'seed-c8', nombre: 'Cena en Hali Country Hotel', tipo: 'Cena',
      loc: { texto: 'Hali Country Hotel, Suðursveit', lat: 64.0344, lng: -15.8912 },
      fecha: '2026-10-10', horario: '20:00', orden: 1440,
      notas: 'A unos 13 km al este de Jökulsárlón, en el mismo Suðursveit que Gerdi Guesthouse — apenas un par de minutos más de coche desde el alojamiento de esta noche, y la opción de restaurante de verdad más cercana a donde dormís. Cocina islandesa con producto de la zona (cordero, trucha ártica); cena 18:00-20:30 en temporada de invierno, conviene confirmar antes. Si preferís algo más barato: no hay más restaurantes cerca de Gerði, así que la alternativa realista es comprar bocadillos en un supermercado de Kirkjubæjarklaustur o Höfn antes de llegar.' },
    ...
    { id: 'seed-c9', nombre: 'Cena en Egilsstaðir', tipo: 'Cena',
      loc: { texto: 'Salt Café & Bistro, Egilsstaðir', lat: 65.2669, lng: -14.3948 },
      fecha: '2026-10-11', horario: '20:30', orden: 1440,
      notas: 'La opción de mejor relación calidad-precio del pueblo: cocina casera de bistró a precio razonable, plato principal aprox. 2.500-4.000 ISK. Llegáis tarde tras el día de más conducción del viaje (Jökulsárlón → Vestrahorn → Egilsstaðir, ~270 km); conviene confirmar que sigue abierto a esa hora. Alternativas: Askur Taproom & Pizzeria (pizzas y hamburguesas, ambiente más animado) o, si llegáis muy tarde, la cafetería de la gasolinera N1 del pueblo.' },
    { id: 'seed-c10', nombre: 'Comida en Reykjahlíð', tipo: 'Almuerzo',
      loc: { texto: 'Gamli Bærinn, Reykjahlíð', lat: 65.6407, lng: -16.9109 },
      fecha: '2026-10-12', horario: '13:00',
      notas: 'Sopa de cordero islandesa a discreción (rellenos gratis), fish & chips y hamburguesas a precio moderado ($$). En el mismo Reykjahlíð donde están Hverir y el resto de paradas de Mývatn, así que no hay que desviarse. Alternativa con más encanto (y algo más cara): Vogafjós Cowshed Café, una granja-restaurante junto al lago donde se come con las vacas al otro lado del cristal — sopa del día unos 4.950-7.160 ISK.' },
    { id: 'seed-c11', nombre: 'Cena en Húsavík', tipo: 'Cena',
      loc: { texto: 'Gamli Baukur, Hafnarstétt, Húsavík', lat: 66.0455, lng: -17.3407 },
      fecha: '2026-10-12', horario: '20:00', orden: 1440,
      notas: 'Pub-restaurante en el puerto: hamburguesas, pizza y fish & chips, aprox. 2.800-3.800 ISK. A un paseo corto del Fosshotel Húsavík. Mañana volvéis a esta misma zona del puerto para el avistamiento de ballenas y la comida de después.' },
    { id: 'seed-c12', nombre: 'Comida en Húsavík', tipo: 'Casual / rápido',
      loc: { texto: 'Fish & Chips, Hafnarstétt, Húsavík', lat: 66.0453, lng: -17.3395 },
      fecha: '2026-10-13', horario: '12:30', orden: 600,
      notas: 'Justo en el puerto, a pie desde donde termina el tour de ballenas — fish & chips en raciones grandes, aprox. 2.800-3.800 ISK (una ración a menudo da para compartir). Después, ruta hacia Goðafoss y Akureyri.' },
    { id: 'seed-c13', nombre: 'Cena en Akureyri', tipo: 'Cena',
      loc: { texto: 'Bautinn, Hafnarstræti, Akureyri', lat: 65.6836, lng: -18.0910 },
      fecha: '2026-10-13', horario: '20:30', orden: 1450,
      notas: 'En un edificio de 1902, uno de los más antiguos de Akureyri; el plato principal incluye barra de ensaladas y sopa. Aprox. 4.000-6.000 ISK por persona — no es el más barato del pueblo, pero sí de los de mejor relación calidad-precio, con raciones generosas. A un paseo corto de Torg Guesthouse, después del paseo por el centro. Alternativa algo más cara: Strikið, con vistas panorámicas sobre el fiordo.' },
    { id: 'seed-c14', nombre: 'Parada de bocata en Staðarskáli', tipo: 'Casual / rápido',
      loc: { texto: 'Staðarskáli N1, Hrútafjörður', lat: 65.0378, lng: -21.0500 },
      fecha: '2026-10-14', horario: '10:30',
      notas: 'Área de servicio icónica de la Ruta 1, aprox. a mitad de camino entre Akureyri y Reikiavik (~200 km desde Akureyri, ~190 km hasta Reikiavik) — parada para estirar las piernas en el tramo de más conducción del viaje (salida de Akureyri a las 08:00, ~5 h en total). Perritos calientes, bocadillos y sopa a precio de gasolinera (perrito ~650-750 ISK). Es solo un bocata rápido, no una comida sentados: no hace falta reservar más de 15-20 min.' },
    { id: 'seed-c15', nombre: 'Cena en Reikiavik', tipo: 'Cena',
      loc: { texto: 'Icelandic Street Food, Lækjargata, Reikiavik', lat: 64.1466, lng: -21.9376 },
      fecha: '2026-10-14', horario: '20:30', orden: 1440,
      notas: 'Sopa de cordero o de pescado servida en cuenco de pan, con rellenos gratis — de las comidas de mejor relación calidad-precio de Reikiavik, aprox. 2.200-2.800 ISK. A unos 15 min andando desde Travel Inn. Alternativa aún más barata y típica: el puesto de perritos calientes Bæjarins Beztu Pylsur (Tryggvagata 1), unos 600-700 ISK la unidad.' },
  ...
  const FOTOS = [
    ...
    { k: ['vestrahorn', 'stokksnes'], f: 'Vestrahorn and Stokksnes beach in Iceland.jpg', c: 'Vestrahorn (Stokksnes)', d: 'Montaña de picos afilados sobre una playa de arena negra, con el Viking Village de atrezo a sus pies.' },
    { k: ['bruarfoss'], f: 'The blue waterfall - Bruarfoss - Iceland (41967794764).jpg', c: 'Brúarfoss', d: 'Cascada del azul más intenso de Islandia, alimentada por el deshielo del glaciar Langjökull, de camino entre Þingvellir y Geysir.' },
    ...
    { k: ['kvernufoss'], f: 'Kvernufoss.JPG', c: 'Kvernufoss', d: 'Cascada de unos 40 m escondida en un cañón musgoso junto al Museo de Skógar; un sendero la rodea por detrás, mucho menos concurrida que Seljalandsfoss.' },
